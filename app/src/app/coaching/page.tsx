    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gradient-to-b from-forest-50 to-cream-500 rounded-lg p-8 space-y-4">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc pl-6 space-y-3 text-body text-charcoal-700">
        ...
        <section className="mb-12">
          ...
          <blockquote className="bg-cream-50 border border-charcoal-100 rounded-lg p-6 sm:p-8 mb-6">
          ...
          <blockquote className="bg-cream-50 border border-charcoal-100 rounded-lg p-6 sm:p-8">
            <p className="text-body italic text-charcoal-800 leading-relaxed">
