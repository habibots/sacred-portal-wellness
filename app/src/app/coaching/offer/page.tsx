    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Program Overview */}
          <section className="mb-16 bg-forest-50 rounded-lg p-8">
            ...
            <ul className="space-y-3 text-body text-charcoal-700">
          ...
          <section className="mb-12 border-l-4 border-forest-600 pl-6">
            ...
            <p className="text-body text-charcoal-700 mb-4 font-medium">
            ...
            <ul className="space-y-2 text-body text-charcoal-700 mb-6">
            ...
            <div className="bg-forest-50 rounded-lg p-4 mb-4">
              <p className="text-body font-medium text-forest-800 mb-2">Bonuses:</p>
              <ul className="space-y-1 text-body text-charcoal-700">
          ...
          {/* Support */}
          <section className="mb-16 bg-cream-600 rounded-lg p-8">
          ...
          <section className="mb-16">
            ...
            <p className="text-body text-charcoal-700 mb-8 text-center max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-forest-50 rounded-lg p-6 text-center border-2 border-forest-200">
                <p className="text-body-sm text-forest-700 font-medium mb-2">Founding Clients</p>
                <p className="text-body-sm text-charcoal-500 mb-4">(3 spots available)</p>
                <p className="text-h2 font-display text-forest-800">$1,800</p>
                <p className="text-body-sm text-charcoal-600 mt-1">for 12 weeks</p>
              </div>
              <div className="bg-forest-50 rounded-lg p-6 text-center border-2 border-forest-400">
                <p className="text-body-sm text-forest-700 font-medium mb-2">Early Access</p>
                <p className="text-body-sm text-charcoal-500 mb-4">(6 spots available)</p>
                <p className="text-h2 font-display text-forest-800">$2,500</p>
                <p className="text-body-sm text-charcoal-600 mt-1">for 12 weeks</p>
              </div>
              <div className="bg-forest-50 rounded-lg p-6 text-center border-2 border-forest-600">
                <p className="text-body-sm text-forest-700 font-medium mb-2">Standard Rate</p>
                <p className="text-body-sm text-charcoal-500 mb-4">&nbsp;</p>
