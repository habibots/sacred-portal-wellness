...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Our herbal blends are carefully curated combinations of traditional herbs known for their beneficial properties. Common herbs include mugwort, rosemary, lavender, calendula, and rose petals. Each blend is designed for specific wellness goals.',
    },
    {
    ...
    },
    {
      ...
      answer: 'No, yoni steaming is not recommended during menstruation. The best time to steam is typically after your period has ended.',
    },
    {
      question: 'Do I need special equipment?',
      answer: 'While you can use a simple pot and stool, we offer specially designed yoni steam seats that make the practice more comfortable and effective. These seats are portable and easy to use.',
    },
    {
