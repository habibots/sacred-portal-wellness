    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h2 className="text-h4 font-display mb-6">Get in Touch</h2>
          ...
          <div className="space-y-6">
            <div>
              ...
              <a 
                ...
                className="text-body text-forest-800 hover:text-forest-700"
              >
        ...
        <div className="bg-cream-600 rounded-lg p-8">
